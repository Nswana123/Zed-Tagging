...
<div class="row">
    <div class="col">
        <div class="card bg-body shadow-sm">
            <div class="card-body">
            <form action="{{ route('noc_tickets.updateSiteFaulty', $ticket_sla->id) }}" method="POST">
        @csrf
        ...
        <div class="row mt-3">
            ...
            <div class="col">
                ...
                <input type="text" class="form-control bg-body shadow-sm @error('fault_type') is-invalid @enderror" name="fault_type" value="{{ old('fault_type', $ticket_sla->fault_type) }}" required autocomplete="off">
                @error('fault_type')
                <div class="invalid-feedback">
                    {{ $message }}
                </div>
        ...
        <div class="row mt-3">
            <div class="col">
                <button type="submit" class="btn btn-primary float-end">Update Fault</button>
            </div>
        </div>
    </form>
