...
<div class="row">
    ...
    <div class="row mt-3">
        ...
        <div class="col-lg">
            <label for="outage_duration">Outage Duration (hrs)</label>
            <input type="text" class="form-control bg-body shadow-sm" name="outage_duration" id="outage_duration" value="{{ old('outage_duration', $ticket->outage_duration ?? '') }}" autocomplete="off">
            @error('outage_duration')
                <span class="text-danger">{{ $message }}</span>
            @enderror
        </div>
    </div>
...
<div class="row mt-3">
                    ...
                    <input type="text" class="form-control bg-body shadow-sm" value="{{ $ticket->closed_date }}" readonly>
                    </div>
                    <div class="col">
                    <label >Time Taken</label>
                    <input type="text" class="form-control bg-body shadow-sm" value="{{ $ticket->time_taken }} HRS" readonly>
                    </div>
                    <div class="col">
                    <label >Closed By</label>
                    <input type="text" class="form-control bg-body shadow-sm" value="{{ $ticket->closedBy->fname }}  {{ $ticket->closedBy->lname }}" readonly>
                    </div>
                </div>
                @endif
    </div>
