...
<div class="row">
    <div class="col">
        <div class="card bg-body shadow-sm">
            ...
            <div class="row">
    <div class="col">
    <form action="{{ route('category.updatesms', $message->id) }}" method="POST">
    @csrf
    ...
    <div class="row mt-3">
        <div class="col">
            ...
            <input type="text" class="form-control bg-body shadow-sm" name="name" 
                value="{{ old('name', $message->name) }}" required autocomplete="off">
            @error('name')
        ...
        <div class="col">
            ...
            <textarea class="form-control bg-body shadow-sm" name="message" rows="3">{{ old('message', $message->message) }}</textarea>
            @error('message')
                <div class="invalid-feedback">
                    {{ $message }}
                </div>
    ...
    <div class="row mt-3">
        <div class="col">
            <button type="submit" class="btn btn-primary float-end">Update Message</button>
        </div>
    </div>
</form>
    </div>
