...
<div class="row">
    ...
    @endif</label>  
            ...
            <div class="card-body">
                               <form action="{{ route('ticketing.updateClaimedtickets', $ticket->id) }}" method="POST" enctype="multipart/form-data">
    @csrf
    @method('PUT') 
...
<div class="col mb-3" >
    ...
    <div class="card-footer">
        ...
        <div class="col float-end">
            ...
            @if($ticket->refund == 'yes')
        
        <button type="button"  class="btn btn-warning float-end m-3 text-white">
        <i class='bx bx-money' ></i> To be Refunded
            </button>
        @else
...
<i class='bx bx-send'></i> Escalate
            ...
            <button type="submit" name="action" value="refund" class="btn btn-success float-end m-3">
            <i class='bx bxs-credit-card-alt'></i> Add To Refunds
            </button>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="assignTicketForm" action="{{ route('escalationGroup') }}" method="POST">
                    @csrf
