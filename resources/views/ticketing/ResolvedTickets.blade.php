...
<div class="home-section">
            ...
            <div class="col">
                <div class="card bg-body shadow-sm">
                    <div class="card-header p-3 text-white" style="background:#0A2558;">
                        <div class="row">
                            <div class="col">
                        Resolved Tickets <span class="badge badge-danger">{{$ResolvedCount}}</span>
                </div>
  ...
  @php
        ...
        ">
                                        ...
                                        <td>
                <a href="{{ route('ticketing.showResolvedTickets', $ticket->id) }}" class="custom-link" title="Ticket Id">{{ $ticket->case_id }}</a>
            </td>
