...
<div class="row">
    ...
    @endif</label>  
            ...
            <div class="card-body">
                               <form action="{{ route('ticketing.quality', $ticket->id) }}" method="POST">
    @csrf
    @method('PUT') 
                                <div class="col-6-ml">
...
<div class="col mb-3" >
    ...
    <div class="card-footer">
        ...
        <button type="submit" name="action" value="rate" class="btn btn-warning                                                                                                                                                                                                                                                                                                                                                                                      float-end m-3">
            <i class='bx bxs-star'></i> Rate
            </button>
