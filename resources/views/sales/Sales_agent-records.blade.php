...
<div class="row">
    <div class="col">
        <div class="card bg-body shadow-sm">
            ...
            <div class="row">
                <div class="col-9">
               Sales Agent Report <span class="badge badge-danger"></span>
                </div>
...
<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    ...
    <tbody>
        @foreach($sales as $sale)
            <tr>
                ...
                <td>  <a href="{{ route('sales.details', [
         'userId' => $sale->user_id, 
         'start_date' => request('start_date', \Carbon\Carbon::today()->toDateString()), 
         'end_date' => request('end_date', \Carbon\Carbon::today()->toDateString())
     ]) }}" class="custom-link">
        {{ $sale->total_sales }}
    </a></td>
    ...
    <tfoot>
        <tr>
            <td colspan="4"><strong>Total Amount Cashed In (ZMW):</strong></td>
